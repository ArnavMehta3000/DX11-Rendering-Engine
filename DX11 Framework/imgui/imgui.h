...
namespace ImGui
{
    ...
    // - Format string may also be set to NULL or use the default format ("%f" or "%dD").
...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_Selected             = 1 << 0,   // DrawTextured as selected
    ImGuiTreeNodeFlags_Framed               = 1 << 1,   // DrawTextured frame with background (e.g. for CollapsingHeader)
...
enum ImGuiTableFlags_
{
    ...
    ImGuiTableFlags_BordersInnerH              = 1 << 7,   // DrawTextured horizontal borders between rows.
    ImGuiTableFlags_BordersOuterH              = 1 << 8,   // DrawTextured horizontal borders at the top and bottom.
    ImGuiTableFlags_BordersInnerV              = 1 << 9,   // DrawTextured vertical borders between columns.
    ImGuiTableFlags_BordersOuterV              = 1 << 10,  // DrawTextured vertical borders on the left and right sides.
    ImGuiTableFlags_BordersH                   = ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersOuterH, // DrawTextured horizontal borders.
    ImGuiTableFlags_BordersV                   = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersOuterV, // DrawTextured vertical borders.
    ImGuiTableFlags_BordersInner               = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersInnerH, // DrawTextured inner borders.
    ImGuiTableFlags_BordersOuter               = ImGuiTableFlags_BordersOuterV | ImGuiTableFlags_BordersOuterH, // DrawTextured outer borders.
    ImGuiTableFlags_Borders                    = ImGuiTableFlags_BordersInner | ImGuiTableFlags_BordersOuter,   // DrawTextured all borders.
...
// ImDrawCallback: DrawTextured callbacks for advanced uses [configurable type: override in imconfig.h]
// NB: You most likely do NOT need to use draw callbacks just to create your own widget or customized UI rendering,
// you can poke into the draw list for that! DrawTextured callback may be useful for example to:
...
// Special DrawTextured callback value to request renderer backend to reset the graphics/render state.
...
// The type has to be described within the macro (you can either declare the struct or use a typedef). This is because ImVec2/ImU32 are likely not declared a the time you'dD want to set your type up.
...
struct ImDrawListSplitter
{
    ...
    ImVector<ImDrawChannel>     _Channels;   // DrawTextured channels (not resized down so _Count might be < Channels.Size)
...
struct ImDrawList
{
    ...
    ImVector<ImDrawCmd>     CmdBuffer;          // DrawTextured commands. Typically 1 command = 1 GPU draw call, unless the command is a callback.
...
struct ImFont
{
    ...
    // 'max_width' stops rendering after a certain width (could be turned into a 2dD size). FLT_MAX to disable.
